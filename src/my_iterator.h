...
template <typename Category, typename T, typename Distance = ptrdiff_t,
          typename Point = T*, typename Reference = T&>
struct iterator {
...
inline typename iterator_traits<InputIterator>::difference_type distance(
  ...
  return distance_dispatch(first, last, iterator_catecory(first));
}
...
inline void advance_dispatch(BidirectionalIterator& i, Distance n,
...
inline void advance_dispatch(RandomAccessIterator& i, Distance n,
                             random_access_iterator_tag) {
  i += n;
}
